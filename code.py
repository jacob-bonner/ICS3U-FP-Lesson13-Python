...
def game_over_scene(alien_count):
    # This function is the game over scene on the PyBadge
    ...
    text1 = stage.Text(width=29, height=14, font=None,
                       palette=constants.NEW_PALETTE, buffer=None)
    text1.move(22, 20)
    text1.text("Final Score: {:0>2d}".format(alien_count))
    text.append(text1)
